...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (age < 5 || age > 18) {
      setError('Age must be between 5 and 18 years');
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        'https://adhd-assessment-backend.onrender.com/api/auth/register',
        {
          method: 'POST',
    ...
    <div className="signup-page-container">
      <div className="signup-page-card">
        ...
        <p className="signup-signin-link">
          ...
          <Link to="/" className="signup-signin-link-anchor">Sign in</Link>
        </p>
      </div>
